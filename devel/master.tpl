...
# DESC: 
# BBOX: 0 0 0 0 0 0
Bigscreen         rock2              size=.281057 movesize=.281057 model3d=bigscreen.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
blackjacktable    rock2              size=.231048 movesize=.231048 model3d=blackjacktable.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
bridge            rock1              size=5.725546 movesize=5.725546 model3d=bridge.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
cactus            bed                size=.106564 movesize=.106564 model3d=cactus.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
camera            rock2              size=.132067 movesize=.132067 model3d=camera.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
Camera45          _walkstruct        size=.132067 movesize=.132067 model3d=camera45.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
chair             sofa               size=.154178 movesize=.154178 model3d=chair.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
checkincounter    rock2              size=1.049377 movesize=1.049377 model3d=checkincounter2.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
comptable         rock1              size=.630449 movesize=.630449 model3d=table.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
copier            _walkstruct        size=.181275 movesize=.181275 model3d=copier.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
couch             sofa               size=.51919 movesize=.51919 model3d=couch.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
crapstable        rock2              size=.701004 movesize=.701004 model3d=crap.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
deskcomp          rock2              size=.437892 movesize=.437892 model3d=deskcomp.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
dinnertable       rock1              size=.302282 movesize=.302282 model3d=dinnertable.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
doubleslots3      _walkstruct        size=.785568 movesize=.785568 model3d=doubleslots3.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
glassspacer       rock2              size=.100156 movesize=.100156 model3d=glasspacer.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
hdtv              rock2              size=.662467 movesize=.662467 model3d=hdtv.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
Kenoboard         rock2              size=.890562 movesize=.890562 model3d=newkeno.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor1          _walkstruct        size=.343304 movesize=.343304 model3d=monitor1.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor10         _walkstruct        size=.343304 movesize=.343304 model3d=monitor10.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor11         _walkstruct        size=.343304 movesize=.343304 model3d=monitor11.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor2          _walkstruct        size=.343304 movesize=.343304 model3d=monitor2.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor3          _walkstruct        size=.343304 movesize=.343304 model3d=monitor3.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor4          _walkstruct        size=.343304 movesize=.343304 model3d=monitor4.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor5          _walkstruct        size=.343304 movesize=.343304 model3d=monitor5.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor6          _walkstruct        size=.343304 movesize=.343304 model3d=monitor6.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor7          _walkstruct        size=.343304 movesize=.343304 model3d=monitor7.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor8          _walkstruct        size=.343304 movesize=.343304 model3d=monitor8.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
monitor9          _walkstruct        size=.343304 movesize=.343304 model3d=monitor9.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
name              _walkstruct        size=.105666 movesize=.105666 model3d=greedo.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
ndmonitor         _walkstruct        size=.343304 movesize=.343304 model3d=ndmonitor.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
paigow            rock2              size=.231048 movesize=.231048 model3d=paigow.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
palmtree          bed                size=.727885 movesize=.727885 model3d=palmtree.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
Phonebooth        rock2              size=.310396 movesize=.310396 model3d=booth.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
pillar            rock1              size=1.520776 movesize=1.520776 model3d=pillar.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
Poker             rock2              size=.302282 movesize=.302282 model3d=pokertable.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
pot               _walkstruct        size=.064684 movesize=.064684 model3d=pot.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
railing           _walkstruct        size=.76947 movesize=.76947 model3d=railing.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
ramp              rock1              size=.339935 movesize=.339935 model3d=ramp.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
roulette2         rock2              size=.717857 movesize=.717857 model3d=roulette2.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
singleslot1       _walkstruct        size=.785568 movesize=.785568 model3d=singleslot1.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
singleslot2       _walkstruct        size=.77989 movesize=.77989 model3d=singleslot2.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
Skinsmonitor      _walkstruct        size=.343304 movesize=.343304 model3d=skinsmonitor.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
soloslot1         _walkstruct        size=.365171 movesize=.365171 model3d=soloslot1.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
soloslot2         _walkstruct        size=.365171 movesize=.365171 model3d=soloslot2.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
soloslot3         _walkstruct        size=.365171 movesize=.365171 model3d=soloslot3.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
soloslot4         _walkstruct        size=.365171 movesize=.365171 model3d=soloslot4.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
spincar2          _walkstruct        size=.493524 movesize=.493524 model3d=mika_f1.3DO
# DESC: 
# BBOX: 0 0 0 0 0 0
springboard       rock2              size=.311006 movesize=.311006 model3d=springboard.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
stairs2           _walkstruct        size=.435488 movesize=.435488 model3d=stairs2.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
storageslot       _walkstruct        size=.785568 movesize=.785568 model3d=storageslot.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
stove             _walkstruct        size=.561805 movesize=.561805 model3d=stove.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
Striplite         _walkstruct        size=.203962 movesize=.203962 model3d=striplite.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
toilet            _walkstruct        size=.071515 movesize=.071515 model3d=toilet2.3do
# DESC: 
# BBOX: 0 0 0 0 0 0
tri               rock2              size=1.498498 movesize=1.498498 model3d=tri.3do
